...
CREATE TABLE regla (id INT AUTO_INCREMENT, nombre TEXT, type VARCHAR(255), lunes TINYINT(1), martes TINYINT(1), miercoles TINYINT(1), jueves TINYINT(1), viernes TINYINT(1), sabado TINYINT(1), domingo TINYINT(1), desde TIME, hasta TIME, cantidadllamadas BIGINT, costomaximo FLOAT(18, 2), INDEX regla_type_idx (type), PRIMARY KEY(id)) ENGINE = INNODB;
CREATE TABLE regla (id INT AUTO_INCREMENT, nombre TEXT, type VARCHAR(255), lunes TINYINT(1), martes TINYINT(1), miercoles TINYINT(1), jueves TINYINT(1), viernes TINYINT(1), sabado TINYINT(1), domingo TINYINT(1), desde TIME, hasta TIME, cantidadllamadas BIGINT, costomaximo FLOAT(18, 2), PRIMARY KEY(id)) ENGINE = INNODB;
