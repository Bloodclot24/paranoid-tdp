...
<div style="border:1px solid black; padding:5px; margin 5px; width:840px">
	<div id="mainGraphic" style="width: 800px; height: 400px; margin: 10 auto">	</div>
</div>
<div style="height:10px; clear:both"/>
<div style="border:1px solid black; padding:5px; margin 5px; width:340px; float:left">
		<div id="llamadasGraphic" style="width: 300px; height: 300px; margin: 10 auto"></div>
</div>
<div style="border:1px solid black; padding:5px; margin 5px; width:488px; float:left">
	<table>
		<tr>
			<td>Usuarios</td>
			<td>324</td>
