...
CREATE TABLE notificaciones (id INT AUTO_INCREMENT, fecha DATETIME, accion TEXT, masinfourl TEXT, llamada TEXT, regla_id INT, user_id BIGINT, leida TINYINT(1) DEFAULT '0', INDEX regla_id_idx (regla_id), INDEX user_id_idx (user_id), PRIMARY KEY(id)) ENGINE = INNODB;
