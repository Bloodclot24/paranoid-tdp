...
abstract class BasesfGuardUserForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'informarAlertas'  => new sfWidgetFormInputCheckbox(),
    ...
    $this->setValidators(array(
      ...
      'pbxuser_id'       => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('PBXUser'), 'required' => false)),
      'perfil_id'        => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('Perfil'), 'required' => false)),
      'informarAlertas'  => new sfValidatorBoolean(array('required' => false)),
